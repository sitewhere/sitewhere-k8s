...
# This script creates a backup of SiteWhere 2.1 MongoDB database
...
function backup_mongodb () {
  ...
  if [[ $# != 1 ]]; then
    ...
    echo "" >&2
    echo "This script creates a backup of SiteWhere 2.1 MongoDB database running on a Kubernetes cluster." >&2
